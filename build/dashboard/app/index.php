...
<body>
  ...
  <div class="container-fluid my-3">
    ...
    <?php if (!$app->valid['valid']): ?>
  
      <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error <?php echo $app->valid['error_id']; ?>:</strong> <?php echo $app->valid['msg']; ?>
        <?php if ($app->valid['error_id'] == 13): ?>
          <br>To fix this issue, change permission on file /var/run/docker.sock with your user id:<br>
          <code>(sudo) chown MY_ID: /var/run/docker.sock</code>
        <?php endif; ?>
  ...
  <!-- Bootstrap 4 + Popper-->
  <script
    src="https://cdn.jsdelivr.net/npm/popper.js@1.13.0/dist/umd/popper.min.js"
