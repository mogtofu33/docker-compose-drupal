...
wget -O $theme/custom/$name/config.rb https://gist.githubusercontent.com/Mogtofu33/99a6a764ce0be20d7faa55c7ed315def/raw/18c33d42f539877bf52df4704ecf293e88e7bdfb/config.rb
